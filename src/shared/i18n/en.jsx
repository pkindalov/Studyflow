export const en = {
  ...
  unsavedScheduleMsg: "You have a schedule that hasn't been saved. If you continue, the task allocations and order will be lost.",
  ...
  helpRecurringTip1: (b) => <>When creating a task, use the {b("Date")} section to pick a single date or a range (From → To), and the {b("Repeat")} section to repeat Daily, Weekly, Monthly, or Yearly.</>,
