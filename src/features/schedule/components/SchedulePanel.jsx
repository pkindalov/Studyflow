...
const SchedulePanel = function({
  ...
  return (
    <>
      {showDeleteConfirm && (
        <div className="fixed inset-0 z-50 bg-black/70 backdrop-blur-sm flex items-center justify-center p-4" role="presentation" onClick={() => setShowDeleteConfirm(false)}>
          <div
            ref={dialogRef}
            role="dialog"
            aria-modal="true"
